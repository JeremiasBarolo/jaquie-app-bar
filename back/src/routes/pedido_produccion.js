    ...
    router.post('/', pedidoValidator ,pedido_produccionController.createpedido_produccion);
    
    router.put('/:pedido_produccion_id',pedidoValidator ,pedido_produccionController.updatepedido_produccion);
